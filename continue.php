...
<html lang="en" style="height:100%;">
    ...
    <![endif]-->         
        ...
        <body data-spy="scroll" data-target="nav" style=" background-image:url('lake.jpg');"> 
...
<h2 style="font-size:60px" "color:blue">found garbage </h2>
<a href='loc.php'><button>share location</button></a>
<h2>places to be cleaned </h2>
 <form action="hello.php" method="post">
	
		<button type="submit" class="btn" name="clean">clean</button></form>
	
	
	<p title="clean bangalore">
